...
function DynamoDbNode({ id, data, selected, positionAbsoluteX }: { id: string; data: any; selected?: boolean; positionAbsoluteX?: number }) {
  ...
  return (
    <NodeTooltip name={data.name} type={data.type || 'DynamoDB'} metrics={data.metrics}>
    <motion.div
      whileHover={{ 
        scale: 1.02, 
